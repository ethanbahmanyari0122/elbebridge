...
const copy = defineCollection({
  ...
  schema: z.object({
    ...
    home: z.object({
      ...
      v5: z.object({
        valueLine: z.array(z.string()).length(3),
        ...
        heroPanel: z.object({
          ...
          status: z.string(),
          intro: richText,
          checks: z.array(z.object({ label: z.string(), status: z.string() })).min(1),
          footer: richText,
        }),
        workstreamsHeading: richText,
        workstreamsIntro: richText,
        workstreams: z.array(z.object({
          ...
          heading: richText,
          intro: richText,
          bullets: z.array(richText).min(1),
          note: richText.optional(),
        })).length(5),
        decisionHeading: richText,
        decisionIntro: richText,
        decisions: z.array(z.object({
          situation: richText,
          article: z.string(),
          result: richText,
        })).length(4),
        decisionNote: richText,
        audiencesHeading: richText,
        audiencesIntro: richText,
        audiences: z.array(z.object({
          kicker: z.string(),
          heading: richText,
          text: richText,
        })).length(3),
        audiencesCta: richText,
        processHeading: richText,
        processIntro: richText,
        deliverablesHeading: richText,
        ...
        processTrust: richText,
        findingsHeading: richText,
        findingsIntro: richText,
        findingsClient: z.string(),
        findingsBadge: z.string(),
        findingLabels: z.object({
          issue: z.string(),
          evidence: z.string(),
          why: z.string(),
          change: z.string(),
        ...
        findings: z.array(z.object({
          ...
          why: richText,
          priority: z.string(),
          priorityTone: z.enum(['high', 'medium']),
          change: richText,
          help: richText,
        })).length(3),
        whyHeading: richText,
        ...
        price: z.object({
          ...
          included: z.array(richText).min(1),
          scopeNote: richText,
          implementationNote: richText,
          cta: z.string(),
        }),
        faqHeading: richText,
        faqIntro: richText,
        faqs: z.array(z.object({ question: richText, answer: richText })).min(4),
      }),
    }),
